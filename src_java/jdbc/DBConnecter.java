...
public class DBConnecter {
    ...
    private static final String URL = "jdbc:mariadb://%s:%s/%s?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
    private static String DB_HOST = "localhost";
    private static String DB_PORT = "3306";
    public static String DB_DATA = "nro";
    public static String DB_USER = "root";
    private static String DB_PASSWORD = "ahwuocdz";
    private static int MIN_CONN = 5;
    private static int MAX_CONN = 20;
    private static long MAX_LIFE_TIME = 300000L; // 5 phút
    private static long CONNECTION_TIMEOUT = 30000L; // 30 giây timeout
...
//            DB_SERVER = properties.getProperty("database.server", DB_SERVER);
    ...
    static {
        ...
        config.setLeakDetectionThreshold(60000); // Phát hiện leak sau 60 giây
