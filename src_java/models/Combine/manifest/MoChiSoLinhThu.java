...
public class MoChiSoLinhThu {
    ...
    private static final int[][] OPTION = { { 0, 6, 7, 5, 27, 28, 50, 77, 103 },
            { 500, 5000, 5000, 5, 5000, 5000, 5, 5, 5 }, // Thường
    ...
    public static void showInfoCombine(Player player) {
        ...
        CombineService.gI().TrungAcMa.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay, "Mở chỉ số",
                "Từ chối");
    }
