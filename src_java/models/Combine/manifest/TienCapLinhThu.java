...
public class TienCapLinhThu {
    ...
    private static final int[][] LINH_THU = {
            { 1811, 1642, 1643, 1652, 1655, 1664, 1695, 1490, 1492, 1493, 1494 },
    ...
    public static void showInfoCombine(Player player) {
        ...
        String npcSay = "Nâng cấp cần x" + requiredItems + " Mảnh cải trang và " + requiredGoldBars
                + " Thỏi vàng với tỷ lệ thành công: " + successRate + "%";
        CombineService.gI().TrungAcMa.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay, "Tiến hóa",
                "Từ chối");
    }
