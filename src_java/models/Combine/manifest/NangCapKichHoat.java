    ...
    public static void startCombineNew(Player player) {
        if (player.combine != null && player.combine.itemsCombine != null && player.combine.itemsCombine.size() == 3) {
            ...
            if (Util.isTrue(35, 100)) {
                ...
                newItem.itemOptions.add(new ItemOption(169, 0));
                 newItem.itemOptions.add(new ItemOption(170, 0));
            }else {
                 newItem.itemOptions.add(new ItemOption(197, 0));
                 newItem.itemOptions.add(new ItemOption(198, 0));
            }
