...
import models.Combine.manifest.TaySaoPhaLe;
...
public class CombineService {
    ...
    public static final int TAY_SAO_PHA_LE = 998;
    ...
    public void showInfoCombine(Player player, int[] index) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case TAY_SAO_PHA_LE -> 
                TaySaoPhaLe.showInfoCombine(player);
    ...
    public void startCombine(Player player, int... n) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case TAY_SAO_PHA_LE ->
                TaySaoPhaLe.startCombine(player);
        }
...
//            msg.writer().writeShort(-1); // y
    ...
    private String getTextTopTabCombine(int type) {
        return switch (type) {
            ...
            case TAY_SAO_PHA_LE  ->
                "Bà Hạt Mít Cho Phép Bạn Tẩy Sao Pha Lê";
            default ->
                "";
        };
    }
    ...
    private String getTextInfoTabCombine(int type) {
        return switch (type) {
            ...
            case TAI_TAO_CAPSULE_KH ->
                "Vào hành trang\nChọn 3 khoáng tái chế\nChọn 1 Capsule vỡ\nSau đó chọn 'Tái tạo'";
            case TAY_SAO_PHA_LE ->
                "Chọn trang bị cần tẩy sao\nChọn Bùa tẩy (Thường hoặc Cao cấp)\nSau đó chọn 'Tẩy Sao'";
            default ->
                "";
        };
    }
