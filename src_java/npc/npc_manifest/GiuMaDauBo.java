...
//                }
                ...
                case 1 ->{
                    int rank = TopService.getTopBangRankByName(player.clan.name);
                     this.createOtherMenu(player, 88, "|5|Top Bang hội là sự cố gắng và nỗ lực của 1 tập thể\n"
                             + "\b|3|Clan bạn đang ở top: "+ rank+ "\n"
                             +" \b|5|Điểm bang: "+ player.clan.Point+"đ\n"
                             + "Các thành viên có thể kiếm điểm bằng cách: \n"
                             + "Hoàn thành nhiệm vụ bang +1đ\n"
                             + "Chiến thắng mỗi hành tinh nrd +5đ\n"
                             + "Thành viên bang kết liễu bot Bang +10đ (naruto và obito)\n"
                             + "Top 3 bang hội sẽ được nhận quà",
                             "Xem Top", "Nhận quà");
                }
                case 2->{
                     Clan clan = player.clan;
...
//                }
                case 3->{
                  ...
                  switch (select) {
                      case 0:
                       Service.gI().sendThongBaoOK(player, TopService.getTopBang());
                            break;
                 ...
                 switch (select) {
                     ...
                     case 2: 
                         ...
                         createOtherMenu(player, 115, "Quyên góp bang hội để nhận ngay Chiến lực bang và xu bang\n"
                                 ...
                                 , "Chan nhẹ\n10 ngọc xanh", "Chan vừa\n 49 ngọc xanh","Chan Mạnh luôn!\n 99 ngọc xanh");
                         }else{
            ...
            switch (select) {
                case 0->{
                        ...
                        + (10 - player.inventory.gem) + " ngọc nữa");
                            return;
                        }
                ...
                case 1->{
                         ...
                         if(player.inventory.gem <49){
                            Service.gI().sendThongBao(player, "Bạn không có đủ ngọc, còn thiếu "
                        + (49- player.inventory.gem) + " ngọc nữa");
                            return;
                        }
                             player.inventory.gem -= 49;
                ...
                case 2->{
                    Item tv = InventoryService.gI().findItemBag(player, 457);
                            ...
                            if(player.inventory.gem <88){
                            Service.gI().sendThongBao(player, "Bạn không có đủ ngọc, còn thiếu "
                        + (88 - player.inventory.gem) + " ngọc nữa");
                            return;
                        }
