    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                switch (mapId) {
                    case 0, 7, 14, 203 -> {
                        String menuText = "\b|1|Đây là nơi ngươi có thể đổi bất cứ thứ gì"
                                + "\nMiễn là ngươi có tiền"
                                + "\b|5|" + cn.BANK_NAME + ": " + cn.STK
                                + "\nCHỦ TÀI KHOẢN: " + cn.CHU_TK + "\n"
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,menuText ,
                                "Mở thành viên",
                                "Đổi skill đệ",
                                "Mua đệ VIP");
                    }
                    ...
                    case 0:
                        if (player.getSession() != null) {
                            this.createOtherMenu(player, 782,
                                    "\b|2|Mở thành viên 20k, Hoặc hoàn thành nhiệm vụ FIde  \n Nhận cải trang Buma thám hiểm 2 ngày và 1 hộp mù baby Three và 100 thỏi vàng\n"
                                            + "Bạn đã nạp :\n"
                ...
                switch (select) {
                    case 0:
                        ...
                        PlayerDAO.updateActive(player, 1);
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã mở thành viên thành công,cải trang Buma thám hiểm và hộp mù baby three và 100 thỏi vàng");
