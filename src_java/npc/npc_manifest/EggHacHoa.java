            ...
            switch (player.iDMark.getIndexMenu()) {
                case ConstNpc.BASE_MENU -> {
                    switch (select) {
                        ...
                        case 3 -> {
                            ...
                            switch (id) {
                                case 1811, 1642, 1643, 1652, 1655, 1664, 1695, 1490, 1492, 1493, 1494:
                                    capbac = "Thường";
                                    break;
                ...
                case ConstNpc.MENU_START_COMBINE -> {
                    switch (player.combine.typeCombine) {
                        case CombineService.NANG_CAP_LINH_THU, CombineService.MO_CHI_SO_LINH_THU,
                                CombineService.PHAN_RA_LINH_THU -> {
                            switch (select) {
                                case 0 ->
