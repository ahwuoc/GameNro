                ...
                case 45 -> {
                        ...
                        switch (select) {
                            ...
                            case 5->
                                this.createOtherMenu(player,
                                        ...
                                        + "Mộc hiện tại đã nhận: "+player.event.getEventPointQuyLao(),
                                        "Xem Mốc Quà", "Hủy bỏ");
                    ...
                    switch (player.iDMark.getIndexMenu()) {
                        ...
                        switch (select) {
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x25 " +duahau.template.name);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x3 " +bas.template.name);
                        }else{
                            Service.gI().sendThongBao(player, "Bạn chưa đủ điều kiện, hoặc đã nhận mốc này rồi");
                        }
                            }
                        ...
                        switch (select) {
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x50 " +duahau.template.name);
...
//                              InventoryService.gI().addItemBag(player, theden);
                            ...
                            // Service.gI().sendThongBao(player, "Bạn đã nhận được x25 " +duahau.template.name);
                            // Service.gI().sendThongBao(player, "Bạn đã nhận được x3 " +theden.template.name);
                        ...
                        switch (select) {
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x400 " +duahau.template.name);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x5 " +tts.template.name);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được Đeo lưng " +lbb.template.name);
                        }else{
                            Service.gI().sendThongBao(player, "Bạn chưa đủ điều kiện, hoặc đã nhận mốc này rồi");
                        }
                            }
                        ...
                        switch (select) {
                            ...
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x400 " +duahau.template.name);
                            Service.gI().sendThongBao(player, "Bạn đã nhận được x5 " +tts.template.name);
                            // Service.gI().sendThongBao(player, "Bạn đã nhận được x5 " +theden.template.name);
