    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            ...
            createOtherMenu(player, ConstNpc.BASE_MENU,
                    "SỔ VŨ TRỤ NGỌC RỒNG REBORN MÙA 1\n Kết thúc vào 23h 31/5\nChào mừng đến với bình nguyên vô vọng", menus);
        }
    }
...
//                    "Xem thông tin hiện tại"
                    ...
                    case 5 -> {
                        ...
                        Service.gI().sendThongBaoFromAdmin(player, "\b|5|Cấp độ Sổ Reborn hiện tại:" + player.sosumenhplayer.getLevel() + vip
