...
import static services.func.Input.DOI_NGOC_HONG;
...
public class OngGohan extends Npc {
    ...
    int[][] napVang = {{20000, 30}, {50000, 100}, {100000, 375}, {500000,2500 }, {1000000, 6000}, {2000000, 14000}, {5000000, 40000}};
        ...
        if (canOpenNpc(player)) {
            if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                    ...
                    this.createOtherMenu(player, ConstNpc.BASE_MENU,
                        ...
                        + "\nDùng COIN, VND hãy qua NPC NAPPA, QUY LÃO ở đảo Kame nhé!!!"
                        + "\n Con có thể nhận quà nạp mốc, đua top sự kiện tại Quy Lão Kame\n"
                        + "Mở thành viên tại NAPPA tại làng\n|1|"
                ...
                switch (select) {
                    ...
                    case 1: // nạp tiền
                        ...
                        createOtherMenu(player, ConstNpc.NAP_TIEN, npcSay,
                                ...
                                "Đổi Thỏi vàng","Đổi Hồng Ngọc"
                                );
                        break;
                    case 2:// xóa đệ
