                ...
                switch (select) {
                    ...
                    case 2 -> {
                        if (BiKiepTuyetKy != null) {
                            ...
                            if (checkskill) {
                                if (duSachTuyetKy && duVang && duNgoc && duSucManh) {
                                    this.createOtherMenu(player, 6,
                                            ...
                                            + "|2|Giá ngọc: 99\n"
                                            + "|2|Sức mạnh: " + Util.powerToString(player.nPoint.power) + "/60 Tỷ",
                                            "Đồng ý", "Từ chối");
                                } else {
                                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                            "|1|Ta sẽ dạy ngươi tuyệt kỹ " + nameSkill + " 1"
                                            ...
                                            + "\n" + (duSucManh ? "|2|" : "|7|") + "Sức mạnh: " + Util.powerToString(player.nPoint.power) + "/60 Tỷ", "Từ chối");
                                }
                            } else {
                                if (duSachTuyetKy && duVang && duNgoc && duSucManh) {
                                    this.createOtherMenu(player, 6,
                            ...
                            if (checkskill) {
                                if (sach.quantity >= 999) {
                                    try {
                                        ...
                                        msgg.writer().writeUTF("zl:0822992003");
