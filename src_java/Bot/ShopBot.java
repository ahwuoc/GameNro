...
public class ShopBot {
    ...
    public String getChat() {
        ...
        String text = String.format("p %s ja x%d %s/1 k%d", it.template.name, this.slot, it1.template.name, this.bot.zone.zoneId);
        return text;
    }
    ...
    public void CheckTraDe(List<Item> item) {
        ...
        int requiredGold = this.slot;
        boolean hasEnoughGold = pl.inventory.gold >= requiredGold;
