...
public class ItemService {
    ...
    public Item randomRac2() {
        short[] racs = { 704, 379, 384, 385, 381, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 934, 935,1150,1151,1152,1153,1154};
   ...
   public Item otpkh(short tempId) {
    ...
    public void settlkaio(Player player) {
            ...
            Item hq = InventoryService.gI().findItem(player.inventory.itemsBag, 1703);
            int[] dotl = new int[]{555, 556, 562, 563, 561};
            
            int ramdom = 4;
           if(Util.isTrue(70,100)){
              ramdom =  Util.nextInt(dotl.length-1);
           }
