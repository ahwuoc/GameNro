...
public class boss_world_1 extends Boss {
    public boss_world_1() throws Exception {
        super(BossID.BOSS_THE_GIOI_1, BossesData.BOSS_WORLD_1);
    }
