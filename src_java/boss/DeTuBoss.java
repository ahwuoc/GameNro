...
/**
 *
 * @author BTH Cute phô mai que cc thua đức
 */
public class DeTuBoss extends Boss {
    ...
    public DeTuBoss() throws Exception {
        super(100, new BossData(
                ...
                new short[] { 1881, 1882, 1883, 139, -1, -1 },
                1000000,
    ...
    public void reward(Player plKill) {
        int[] listitem = { 1823, 1739, 457, 1882 };
        for (int i = 1; i < Util.nextInt(1, 5); i++) {

            Service.gI().dropItemMap(
                    this.zone,
                    new ItemMap(zone, listitem[Util.nextInt(0, 3)], 1, this.location.x + i * 10, this.location.y, -1));
        }
