...
public class TuanLoc extends Boss {
    ...
    public TuanLoc() throws Exception {
        super(CHRISTMAS_EVENT, BossID.TUAN_LOC - Util.nextInt(1000000), BossesData.TUAN_LOC);
    }
                ...
                if (dis > 450) {
                    ...
                    if (Util.canDoWithTime(lastTimeAtt, 30000) && this.nPoint.hp < this.nPoint.hpMax) {
                        if (Util.isTrue(10, 100)) {
                            ...
                            pl.setDie();
                            Service.gI().sendThongBao(pl, "Bạn đã bị tuần lộc húc chết!");
                        }
    ...
    public void afk() {
        if (Util.canDoWithTime(this.lastTimeAttack, 500)) {
            ...
            if (pl.haveRewardTuanLoc) {
                pl.haveRewardTuanLoc = false;
                this.leaveMap();
                return;
            }
            if (this.zone.equals(pl.zone)) {
                ...
                if (dis <= 300) {
                    ...
                    afk = false;
                    pl.canRewardTuanLoc = true;
                } else {
                    afk = true;
                    pl.canRewardTuanLoc = false;
                }
            } else if (!afk) {
                if (pl.changeMapVIP) {
