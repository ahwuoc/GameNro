...
public class O_DO1 extends Boss {
    ...
    public O_DO1() throws Exception {
        super(ANTROM, BossID.O_DO1, new BossData(
                ...
                new String[]{"|-1|Hôi Hôi Hôi!! :))"},
                new String[]{"|-1|Hôi Hôi Qúa :))", "|-2|Hôi quá tránh ra đi....", "|-2|Cút ngay không là ăn đòn"},
...
public long injured(Player plAtt, long damage, boolean piercing, boolean isMobAttack) {
    ...
    public void reward(Player plKill) {
       ...
       if(rand>=0&&rand<20){
        ...
        ItemMap it = new ItemMap(this.zone, id, 1, this.location.x + Util.nextInt(-15, 15), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
