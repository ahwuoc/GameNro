...
public class NPoint {
    ...
    private void setPointWhenWearClothes() {
        ...
        if (this.player.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.player.inventory.itemsBag.stream().filter(it -> it.isNotNullItem() && it.template.id == 1810).findFirst().ifPresent(btc3 -> {
...
//        }
        ...
        // Xử lý rồng băng
        if (player.itemTime != null && player.itemTime.isUseRB) {
            hpMax += (hpMax * 10L / 100L);
        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu1Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                hpMax += calPercent(hpMax - this.player.pet.nPoint.hpMax, 10);
            }
        }

        if (this.player.itemTime != null && this.player.itemTime.ispho1) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                hpMax += calPercent(hpMax, 50);
            } else {
                long hpPlayerOnly = hpMax - this.player.pet.nPoint.hpMax;
                hpMax += calPercent(hpPlayerOnly, 50);
            }
        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu2Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                hpMax += calPercent(hpMax - this.player.pet.nPoint.hpMax, 15);
            }

        }
        
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThuDb) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                hpMax += calPercent(hpMax, 20);
            } else {
                hpMax += calPercent(hpMax - this.player.pet.nPoint.hpMax, 20);
            }
        }
        
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungHop) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                hpMax += calPercent(hpMax, 25);
            } else {
                hpMax += calPercent(hpMax - this.player.pet.nPoint.hpMax, 25);
            }
        }
        ...
        if (this.player.isPet) {
            ...
            //            3      1       2      4
            // Fusion PORATA1, PORATA2
            if (typeFusion == ConstPlayer.HOP_THE_PORATA || typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            ...
            // Fusion PORATA2, PORATA3
            if (typeFusion == ConstPlayer.HOP_THE_PORATA2 || typeFusion == ConstPlayer.HOP_THE_PORATA3) {
...
//        }
    ...
    private void setMpMax() {
        ...
        if (this.player.isClone) {
            this.mpMax = Util.getPercent((int) ((PlayerClone) this.player).master.nPoint.mpMax, SkillUtil.getPercentPhanThan(player));
            return;
        }
...
//        }
        ...
        if (this.player.isPet) {
            ...
            if (typeFusion == ConstPlayer.HOP_THE_PORATA || typeFusion == ConstPlayer.HOP_THE_PORATA2) {
                switch (typePet) {
                    case 1 ->
                        bonusMap.put(typePet, 10);  // Mabư
                    case 2 ->
                        bonusMap.put(typePet, 20);  // Berus
                    case 3 ->
                        bonusMap.put(typePet, 15);  // Pic
                    case 4 ->
                        bonusMap.put(typePet, 25);  // Black
                }
            }
            ...
            if (typeFusion == ConstPlayer.HOP_THE_PORATA2 || typeFusion == ConstPlayer.HOP_THE_PORATA3) {
                switch (typePet) {
                    case 1 ->
                        bonusMap.put(typePet, 25);  // Mabư
                    case 2 ->
                        bonusMap.put(typePet, 25);  // Berus
                    case 3 ->
                        bonusMap.put(typePet, 20);  // Pic
                    case 4 ->
                        bonusMap.put(typePet, 30);  // Black
                }
            }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu1Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.mpMax += calPercent(this.mpMax - this.player.pet.nPoint.mpMax, 10);
            }
        }
        
        if (this.player.itemTime != null && this.player.itemTime.ispho3) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                this.mpMax += calPercent(this.mpMax, 20);
                this.critAdd += calPercent(this.critAdd, 10);
            } else {
                this.mpMax += calPercent(this.mpMax - this.player.pet.nPoint.mpMax, 20);
                this.critAdd += calPercent(this.critAdd - this.player.pet.nPoint.critAdd, 10);
            }
        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu2Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.mpMax += calPercent(this.mpMax - this.player.pet.nPoint.mpMax, 15);
            }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungHop) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.mpMax += calPercent(this.mpMax - this.player.pet.nPoint.mpMax, 25);
            }
        }
...
//        }
        if (this.player.isClone) {
            this.dame = Util.getPercent((int) ((PlayerClone) this.player).master.nPoint.dame, SkillUtil.getPercentPhanThan(player));
            return;
        }
        if (this.player.isPet) {
            Pet pet = (Pet) this.player;
            ...
            // Tăng dame theo điều kiện PORATA2 hoặc PORATA3
            if (typeFusion == ConstPlayer.HOP_THE_PORATA2 || typeFusion == ConstPlayer.HOP_THE_PORATA3) {
                switch (typePet) {
                    case 1 ->
                        bonusDame += 15; // Mabư
...
//        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu1Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.dame += calPercent(this.dame - this.player.pet.nPoint.dame, 10);
            }
        }
        
        if (this.player.itemTime != null && this.player.itemTime.ispho2) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                this.dame += calPercent(this.dame, 20);
                this.tlNeDon += calPercent(this.tlNeDon, 10);
            } else {
                this.dame += calPercent(this.dame - this.player.pet.nPoint.dame, 20);
                this.tlNeDon += calPercent(this.tlNeDon - this.player.pet.nPoint.tlNeDon, 10);
            }
        }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungThu2Trung) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.dame += calPercent(this.dame - this.player.pet.nPoint.dame, 15);
            }
        ...
        if (this.player.itemTime != null && this.player.itemTime.isBanhTrungHop) {
            if (this.player.fusion.typeFusion == ConstPlayer.NON_FUSION) {
                ...
                this.dame += calPercent(this.dame - this.player.pet.nPoint.dame, 25);
            }
        }
