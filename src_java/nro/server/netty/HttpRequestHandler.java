package nro.server.netty;

import consts.ConstAdminCommand;
...
//                                return createMessage("succes", String.valueOf(Client.gI().getSessions().size()));
    ...
    public JSONObject addGoldBar(int quantity) {
        ...
        InventoryService.gI().addItemBag(this.player, item);
        InventoryService.gI().sendItemBag(this.player);
        Service.gI().sendThongBao(this.player, "Bạn nhận được " + quantity + " Thỏi Vàng");
    ...
    public JSONObject addRuby(int quantity) {
        ...
        Service.gI().sendThongBao(this.player, "Bạn nhận được " + quantity + " Hồng Ngọc");
        return createMessage("success", "Thành công!");
    }
    ...
    public JSONObject addGold(int quantity) {
        ...
        PlayerService.gI().sendInfoHpMpMoney(this.player);
        Service.gI().sendThongBao(this.player, "Bạn nhận được " + quantity + " Vàng");
    ...
    public JSONObject addItem(short itemID, int quantity, boolean upToUp, boolean addOptionsInList) {
        ...
        InventoryService.gI().sendItemBag(this.player);
        Service.gI().sendThongBao(this.player, "Bạn nhận được " + item.template.name + " Số lượng: " + quantity);
        return createMessage("success", "Thêm thành công!");
    }
