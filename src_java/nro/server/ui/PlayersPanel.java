...
public class PlayersPanel extends JPanel {
    ...
    private void loadPlayersFromDB(String keyword) {
        new Thread(() -> {
            ...
            String sql = "SELECT p.id, p.head, p.name, p.power, p.clan_id, p.data_inventory, p.items_bag, p.items_box, a.active, a.ban FROM player p LEFT JOIN account a ON p.account_id = a.id ";
