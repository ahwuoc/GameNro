...
public class PlayerService {
    ...
    public void sendInfoHp(Player player) {
        ...
        try {
            ...
            msg.writeLongByEmti(Util.maxIntValue(player.nPoint.hp),ConstNpcConfig.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writeLongByEmti(Util.maxIntValue(player.nPoint.mp),ConstNpcConfig.readInt);
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writeLongByEmti(Util.maxIntValue(player.nPoint.hp),ConstNpcConfig.readInt);//chp
            msg.writeLongByEmti(Util.maxIntValue(player.nPoint.mp),ConstNpcConfig.readInt);//cmp
