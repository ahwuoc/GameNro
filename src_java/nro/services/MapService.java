...
public class MapService {
    ...
    public boolean isMapCold2(int mapId) {
        return mapId >= 195 && mapId <= 197;
    }
    ...
    public boolean isMapOfflineNe(int mapId) {
        return (mapId >= 45 && mapId <= 50 && mapId != 47) || mapId == 154;
    }
    ...
    public boolean isMapTeacherDay(int mapId) {
        return mapId == 6 || mapId == 10 || mapId == 68 || mapId == 69 || mapId == 70;
    }
    ...
    public boolean isMapUpPoratavevang(int mapId) {
        return mapId == 186;
    }
