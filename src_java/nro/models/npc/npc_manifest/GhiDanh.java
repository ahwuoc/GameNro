            ...
            if (this.mapId == 52) {
                ...
                switch (player.iDMark.getIndexMenu()) {
                    case ConstNpc.MAY_DAM -> {
                        switch (select) {
                            case 0 ->
                                TopService.gI().showListTopTraiDat(player, Manager.Topmaydam);
                            case 1 ->
                                TopService.gI().showListTopNamek(player, Manager.Topmaydam);
                            case 2 ->
                                TopService.gI().showListTopXayda(player, Manager.Topmaydam);
                            case 3 -> {
                                if (player.point_maydam >= 10) {
                                    Service.gI().sendThongBaoOK(player, "Bạn đang có " + player.point_maydam + " Điểm");
                                } else {
