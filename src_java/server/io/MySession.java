        ...
        if (this.player == null) {
            ...
            try {
                ...
                if (pl != null) {
                    ...
                    pl.nPoint.calPoint();
                    pl.nPoint.setHp(Util.toIntOrLong(pl.nPoint.hp));
                    pl.nPoint.setMp(Util.toIntOrLong(pl.nPoint.mp));
                    pl.zone.addPlayer(pl);
                    if (pl.pet != null) {
                        pl.pet.nPoint.calPoint();
                        pl.pet.nPoint.setHp(Util.toIntOrLong(pl.nPoint.hp));
                        pl.pet.nPoint.setMp(Util.toIntOrLong(pl.nPoint.mp));
                    }
